...
require$$3$1.ipcMain.handle("dashboard:stats", async () => {
  try {
...
require$$3$1.ipcMain.handle("livres:get", async () => {
  try {
...
require$$3$1.ipcMain.handle(
  "livres:add",
  async (_event, titre, description, disponible, auteurId) => {
    try {
...
require$$3$1.ipcMain.handle(
  "livres:update",
  async (_event, id, titre, description, disponible, auteurId) => {
    try {
...
require$$3$1.ipcMain.handle("livres:delete", async (_event, id) => {
  try {
...
require$$3$1.ipcMain.handle("auteurs:get", async () => {
  try {
...
require$$3$1.ipcMain.handle("auteurs:add", async (_event, nom, biographie) => {
  try {
...
require$$3$1.ipcMain.handle("auteurs:delete", async (_event, id) => {
  try {
...
require$$3$1.ipcMain.handle(
  "auteurs:update",
  async (_event, id, nom, biographie) => {
    try {
...
require$$3$1.ipcMain.handle("categories:get", async () => {
  try {
...
require$$3$1.ipcMain.handle("categories:add", async (_event, nom) => {
  try {
...
require$$3$1.ipcMain.handle("categories:update", async (_event, id, nom) => {
  try {
...
require$$3$1.ipcMain.handle("categories:delete", async (_event, id) => {
  try {
    await prisma.livreCategorie.deleteMany({
      where: {
        categorieId: id
...
require$$3$1.ipcMain.handle(
  ...
  async (_event, livreId, categorieIds) => {
    try {
      await prisma.livreCategorie.deleteMany({
        where: {
          livreId
...
require$$3$1.ipcMain.handle("utilisateurs:get", async () => {
  try {
...
require$$3$1.ipcMain.handle("emprunts:get", async () => {
  try {
...
require$$3$1.ipcMain.handle(
  "emprunts:add",
  async (_event, utilisateurId, livreId) => {
    try {
...
require$$3$1.ipcMain.handle("emprunts:return", async (_event, id) => {
  try {
...
require$$3$1.ipcMain.handle("emprunts:delete", async (_event, id) => {
  try {
    const emprunt = await prisma.emprunt.findUnique({
      where: {
        id
...
require$$3$1.ipcMain.handle("avis:get", async () => {
  try {
...
require$$3$1.ipcMain.handle(
  "avis:add",
  async (_event, note, commentaire, utilisateurId, livreId) => {
    try {
      if (note < 1 || note > 5) {
        return null;
      }
...
require$$3$1.ipcMain.handle(
  "avis:update",
  async (_event, id, note, commentaire) => {
    try {
      if (note < 1 || note > 5) {
        return null;
      }
...
require$$3$1.ipcMain.handle("avis:delete", async (_event, id) => {
  try {
